...
app.get('/', (req, res) => {
  res.send('LDS Sheet Music API is running!')
})
...
const startServer = async () => {
  ...
  app.listen(PORT, () => {
    ...
    console.log(`Access at http://localhost:${PORT}/customers`);
    console.log(`Access at http://localhost:${PORT}/api-docs`);
  });
}; 
